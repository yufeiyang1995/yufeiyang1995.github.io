...
最后，利用kubectl命令搭建创建多个服务，其中可以用在项目中的配置文件配置几个服务之间的关系，服务地址可以直接用kubernate服务名称代替。

开启nginx服务映射到80端口，

```
sudo kubectl port-forward svc/tnginx-yunsou 80:80
```

修改/etc/hosts文件，使得访问域名可以访问到本地集群的服务
